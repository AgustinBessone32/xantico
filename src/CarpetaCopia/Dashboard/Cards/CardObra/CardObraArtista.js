                    ...
                    >
                        ...
                        <Grid item lg={10} sm={12} xs={12}>
                            ...
                            >
                                ...
                                <Grid item container>
                                    <Typography sx={{fontWeight: 400}}><span style={{fontWeight: 600}}>Artista: </span>
                                        {item.artista}
                                    </Typography>
                                </Grid>
                                ...
                                <Grid item container>
                                    <Typography sx={{fontWeight: 400}}><span style={{fontWeight: 600}}>Nombre (ENG): </span>
                                        {item.nomeng}
                                    </Typography>
                                </Grid>
...
export default CardObraArtista;
